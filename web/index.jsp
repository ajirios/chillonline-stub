<%-- 
    Document   : index
    Created on : 22-Dec-2019, 5:05:59 AM
    Author     : mac
--%>

<jsp:forward page="/nigeria" />
...
<html>
    <head>
        ...
        <meta name="description" content="The official website for all things Pepperspot: food, tv, animation, mobile electronics, cafes, dish, cell towers, theme parks, reservations, movies, tv series, games, videos, music, cloud, WiFi, shopping, and more!"/>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <body onload="setApplication()">
        ...
        <div  class="board">
            <a href="javascript:" style="color:inherit;text-decoration:inherit;"><span style="color:rgba(255, 255, 255, 0.99);">FOOD</span></a>
            <a href="javascript:" style="color:inherit;text-decoration:inherit;"><span>TV</span></a>
            <a href="javascript:" style="color:inherit;text-decoration:inherit;"><span>INTERNET</span></a>
            <a href="javascript:" style="color:inherit;text-decoration:inherit;"><span>MOBILITY</span></a>
            <a href="javascript:" style="color:inherit;text-decoration:inherit;"><span>CLOUD</span></a>
        </div>
        ...
        <div class="navigation">
            <div class="logos">
                ...
                <img src="images/pepperspot-yellow.png" alt="log" width="230" />
                </a>
            </div>
            <div class="login">
               <a href="javascript:openApps()" style='text-decoration:inherit;color:inherit;'><span>Login to eat</span></a> &nbsp; 
              <!-- <a href="kitchen/carrier/signup.jsp" style='text-decoration:inherit;color:inherit;'><span>Become a food courier</span></a> &nbsp; 
                <a href="kitchen/signup.jsp" style='text-decoration:inherit;color:inherit;'><span>Free shipping</span></a> &nbsp; 
               --> 
               <a href="javascript:openLogin()" style='text-decoration:inherit;color:inherit;'><span style="width:400px;height:60px;background-color:#faa61a;color:#fed;text-align:center;box-shadow:0 3px 12px #ccc;padding:10px;">Create an account, get $5</span></a>
            </div>
        </div>
        ...
        <div class="entrance">
            <div style="font-size:37px;height:80px;padding-top:20px;"><b><!-- broadest, an around-the-globe -->What can you eat today?</b></div>
            <p>Providing network coverage to India, Asia, South America, Africa and some European countries.</p>
        </div>
        ...
        <div class="bar">
            ...
            <div class="address-bar">
                ...
                <form id="address-form" method="post" action="kitchens/place.jsp">
                        ...
                        <input type="text" class="search-address" id="pac-input" placeholder="Enter a delivery address" />
            ...
            <div class="bar-button">
                <button onclick="location.href='kitchens/place.jsp';" id="delivery-button">DELIVERY</button>
            </div>
            <div class="bar-button">
            ...
            <div hidden class="bar-bottom">
                <a href="tv/channel.jsp" target="_blank" style='text-decoration:inherit;color:inherit;'><div class="bar-icon"><img src="images/tv (1).png" alt="icon" /></div></a>
                <a href="kitchens/place2.jsp" style='text-decoration:inherit;color:inherit;'><div class="bar-icon"><img src="images/dinner.png" alt="icon" /></div></a>
                <a href="music/shelf.jsp" style='text-decoration:inherit;color:inherit;'><div class="bar-icon"><img src="images/musical-note.png" alt="icon" /></div></a>
                <a href="dvd/shelf.jsp" style='text-decoration:inherit;color:inherit;'><div class="bar-icon"><img src="images/dvd-rom-logotype.png" alt="icon" /></div></a>
                <a href="game/shelf.jsp" style='text-decoration:inherit;color:inherit;'><div class="bar-icon"><img src="images/video-game.png" alt="icon" /></div></a>
                <a href="tv/channel.jsp" style='text-decoration:inherit;color:inherit;'><div class="bar-icon"><img src="images/film.png" alt="icon" /></div></a>
                <a href="books/shelf.jsp" style='text-decoration:inherit;color:inherit;'><div class="bar-icon"><img src="images/books.png" alt="icon" /></div></a>
                <a href="tv/channel.jsp" style='text-decoration:inherit;color:inherit;'><div class="bar-icon"><img src="images/shopping-bag (1).png" alt="icon" /></div></a>
               <!-- <div class="bar-icon"><img src="images/ice-cream-cone.png" alt="icon" /></div> -->
               <a href="tv/channel.jsp" style='text-decoration:inherit;color:inherit;'><div class="bar-icon"><img src="images/cocktail.png" alt="icon" /></div></a>
            </div>
        </div>
        ...
        <div class="chatline">
            <div class="chatinvite">Order with us</div>
            <div class="chatlanguage"> | English</div>
            <div class="chatimage">
                                    ...
                                    <div id="mapwrapper">
                                      <div id="mapbase"><!-- V4.1 -->
                                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 500" xml:space="preserve">
                                          <g>
                                            <path id="wdcrjs1" vector-effect="non-scaling-stroke" fill="#faa61a" stroke="#FFFFFF" d="M666.931,154.749c-1.485-6.81-7.11,5.604-11.036,2.338c-0.738-0.615-3.502,0.704-3.502-0.765c-9.55,0.765-6.366,9.55-14.962,6.578c0.637,7.11-2.53,3.268,0.85,13.689c1.272,3.926,6.261-1.274,1.272,7.641c4.67,1.061,17.87,2.784,16.447-2.547c-1.272-4.775,8.384-1.91,7.853-7.004c-0.53-5.094,6.686-3.608,4.352-7.429c-0.901-1.474,3.582-2.334-0.425-5.837c-1.439-1.258,7.209-1.551,9.339-4.455C670.664,154.044,669.044,164.439,666.931,154.749z"/>
                                            <path id="wdcrjs2" vector-effect="non-scaling-stroke" fill="#faa61a" stroke="#FFFFFF" d="M513.914,143.8c-1.804,0.425-1.804-3.714-1.38-4.244c-0.425-0.694-1.839-1.495-1.839-1.83c-1.264-0.024-1.778,0.857-1.875,2.253c1.805,2.548-1.556,2.653,2.122,8.065C512.534,143.481,512.534,148.895,513.914,143.8z"/>
                                            <path id="wdcrjs3" vector-effect="non-scaling-stroke" fill="#faa61a" stroke="#FFFFFF" d="M443.985,175.67c-12.31-0.282,0.664,4.386-11.282,7.924c-2.667,0.79-10.203,4.669-10.203,4.669v4.103l12.032,9.335l18.345,14.045c0,0-0.965,2.785,3.902,3.645c7.216,1.273-0.989,5.673,5.629,4.244c12.45-2.688-6.322,2.971,24.067-16.412c-0.96-6.226-2.019,0.778-5.979-7.217c-3.071-6.196,2.115-1.882-1.278-17.686c-2.46-11.46-8.773-10.753-3.754-15.563c3.308-3.172-0.635-5.801,1.205-8.7c-3.537,1.556-2.618-1.698-8.914,0.565c-2.715,0.976-6.085-3.113-24.054,6.154C445.4,167.464,448.953,175.784,443.985,175.67z"/>
                                            <path id="wdcrjs4" vector-effect="non-scaling-stroke" fill="#faa61a" stroke="#FFFFFF" d="M457,137.859c0.547-0.719-0.663-1.803-1.391-0.719C454.813,138.328,456.453,138.578,457,137.859z"/>
                                            <path id="wdcrjs5" vector-effect="non-scaling-stroke" fill="#faa61a" stroke="#FFFFFF" d="M499.907,357.833c14.644-0.849,3.004,5.41,24.015,0.53L519.5,353.8v-12.097l6.65-0.637c-0.306-2.232,0.009-4.637,0.036-6.685c-9.231,0.954-6.878-10.294-6.985-12.733c-0.105-2.441,2.45-0.638-3.916-2.124c-6.367-1.485-0.845,3.078-7,3.609c-6.155,0.53-5.516-4.883-5.834-6.969c-0.318-2.087-10.504-1.097-13.829,0c7.463,17.421-1.343,3.679,4.882,18.747c1.291,3.126-5.66,4.386-7.045,22.214C489.826,353.8,489.943,358.41,499.907,357.833z"/>
        ...
        <div class="founders">Pepperspot was founded in the city of Lagos, Nigeria. With our first office opening in Kitchener, Ontario, Canada.</div>
        
        
        
        <div hidden class="contact">
            <div class="contact-founder">Osauzo, Ajiri Jeffrey<br>Founder, CEO<br>ajirios@pepperspot.com</div>
            <div class="contact-cofounder">Wale Ajiboye, CTO<br>ajiboyew@pepperspot.com</div>
        </div>
        
        
        
        <!--
        <h5>&nbsp;<b>Pepperspot powers internetworking for specialised industries in offline communities</b></h5>
        <p style="font-size:14px;">&nbsp;Pepperspot's Eat is a leading online food delivery platform pushing the frontiers of 
            food delivery in Continental Africa, the Americas, and Asia, connecting consumers and restaurants through its platform in 12 African countries, 2 Asian countries, and Canada.</p>
        <br>
        -->
        ...
        <div class="locations">
        <h5><b>Find us in these locations in Nigeria</b></h5>
        Pepperspot is a Nigeria-based multinational lifestyle technology company that develops hardware and software for entertainment, telecommunications, and food deliveries, aided by its website, http://pepperspot.com . Our first café office is located in Victoria Island, Lagos, Nigeria.
        </div>
        ...
        <footer>
            <div class='footer-top'>
                <div class='footer-third'>
                    ...
                    <ul>
                        <li><a href="#" style='text-decoration:inherit;color:inherit;'>Eat</a></li>
                        <li><a href="#" style='text-decoration:inherit;color:inherit;'>Internet TV</a></li>
                        <li><a href="#" style='text-decoration:inherit;color:inherit;'>Dish Program</a></li>
                        <li><a href="#" style='text-decoration:inherit;color:inherit;'>Cloud</a></li>
                        <li><a href="#" style='text-decoration:inherit;color:inherit;'>Film</a></li>
                        <li><a href="#" style='text-decoration:inherit;color:inherit;'>Game</a></li>
                        <li><a href="#" style='text-decoration:inherit;color:inherit;'>WiFi</a></li>
                        <li><a href="#" style='text-decoration:inherit;color:inherit;'>Parks</a></li>
                        <li><a href="#" style='text-decoration:inherit;color:inherit;'>Reservations</a></li>
                        <li><a href="#" style='text-decoration:inherit;color:inherit;'>Internet Cafes</a></li>
                    </ul>
                </div>
                <div class='footer-third'>
                ...
                <div class='footer-third'>
                    ...
                    <ul>
                        <li><a href="about.jsp" style='text-decoration:inherit;color:inherit;'>About</a></li>
                        ...
                        <li><a href="#" style='text-decoration:inherit;color:inherit;'>Careers</a></li>
                        ...
                        <li><a href="kitchen/application.jsp" style='text-decoration:inherit;color:inherit;'>My Kitchen</a></li>
                        <li><a href="courier/application.jsp" style='text-decoration:inherit;color:inherit;'>My Carrier</a></li>
            ...
            <div class='footer-bottom'>
                ...
                <div>Based in Kitchener, Ontario, Canada and Lagos, Nigeria.</div>
            </div>
        </footer>
    ...
    <script type="text/javascript">
        ...
        <script type="text/javascript">
            ...
            {
                document.title = "Pepperspot | Official Site";
                
                window.location.href = "/Pepperspot/nigeria";
            }
