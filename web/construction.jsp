...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <body onload="setApplication()">
        ...
        <div class="navigation">
            ...
            <div class="login">
                <a href="tv/channel.jsp" target="_blank" style='text-decoration:inherit;color:inherit;'><span>TV station demo</span></a> &nbsp; 
               <a href="javascript:openLogin()" style='text-decoration:inherit;color:inherit;'><span>Back the project</span></a>
            </div>
        </div>
        ...
        <div class="service-map">
            <div class="service-areas">COMING SOON</div>
        ...
        <div class="founders">Our team is conducting research on modernizing telecommunications. Contact the founder, Ajiri Jeffrey Osauzo through this <a href="https://www.linkedin.com/public-profile/in/ajirios?trk=org-employees_profile-result-card_result-card_full-click" target="_blank">link</a> or at ajirios@pepperspot.com .</div>
        ...
        <div class="locations">
        <h5><b>Learn about what we do</b></h5>
        ...
        <div class="service-map">
            <div class="faq-heading">COVERAGE</div>
    ...
    <script type="text/javascript">
        ...
        <script type="text/javascript">
            ...
            {
                document.title = "Pepperspot | Coming Soon Under Construction";
            }
