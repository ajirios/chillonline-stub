<%-- 
    Document   : login
    Created on : 4-Oct-2020, 12:20:37 AM
    Author     : mac
--%>
...
<html>
    <head>
        ...
        <title>Pepperspot | Kitchen Log In</title>
...
.container .checkmark:after {
    ...
    <%
            ...
            <!-- <span style="margin-top:2px;margin-left:6px;color:white;font-size:20px;float:left;"><b>| Canada</b></span> -->
					...
					<nav id="nav">
						<ul>
							...
							<li><a href="../onboarding/distributor.jsp" class="button">DISTRIBUTE YOUR PRODUCTS</a></li>
							...
							<li>
                                                            ...
                                                            <a  href="javascript:setActive()" id="account-signifier" class="icon fa-angle-down">Carrier Centre</a>
        ...
        <div class="wrapper">
            ...
            <div class="back-picture"><img src="/outlets/gps.jpg" alt="gps" width="100%" /></div>
        
        <div class="entry"><span>Register your vehicle<br><br>and earn weekly in<br><br>your free time.<br><br></span></div>
