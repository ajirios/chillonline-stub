<%-- 
    Document   : signup
    Created on : 4-Oct-2020, 12:20:24 AM
    Author     : mac
--%>
...
<html>
    <head>
        ...
        <title>Kitchen Sign Up | Pepperspot</title>
    ...
    <body onload="init()">
        ...
        <div class="navigation">
            ...
            <div class="login">
                <a href="javascript:" style='text-decoration:inherit;color:inherit;'><span>Other apps &nbsp; LOG IN</span></a>
            </div>
        </div>
        
        <div class="entrance">
            <h1>Connect to the world's fastest-growing food delivery network.</h1>
        ...
        <div class="bar">
            <div class="address-bar">
                <input type="text" id="search-address" placeholder="Enter your kitchen address to get started" />
            </div>
        ...
        <h5>Pepperspot Catering is a leading food delivery marketplace in 200 countries and counting.</h5>
        <p style="font-size:14px;">Pepperspot.com's catering service is a leading online food delivery marketplace pushing the frontiers of 
            ...
            <div class='footer-top'>
                <div class='footer-third'>
                    ...
                    <ul>
                        ...
                        <li><a href="#" style='text-decoration:inherit;color:inherit;'>Catering</a></li>
                        ...
                        <li><a href="#" style='text-decoration:inherit;color:inherit;'>Nightlife</a></li>
                    </ul>
                </div>
                <div class='footer-third'>
                ...
                <div class='footer-third'>
                    ...
                    <ul>
                        ...
                        <li><a href="#" style='text-decoration:inherit;color:inherit;'>Press</a></li>
                        ...
                        <li><a href="#" style='text-decoration:inherit;color:inherit;'>Connect your Kitchen</a></li>
