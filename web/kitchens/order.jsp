    ...
    <script>
        ...
        <div class="panel-area">
            ...
            <div class="order-panel">
                ...
                <div class="receipt-sender"><h5>CACTUS LOUNGE (OZUMBA-MBADIWE ST.)</h5></div>
                <div class="calculations-holder">
                    <div class="subtotal-calculator">
                        <div class="calc-text">Order Subtotal</div>
                        <div class="calc-fee">&#x20A6;<span id="subtotal-span"><%= "2060.00" %></span></div>
                        <div hidden>$<span id="carrier-pay"><%= "50.00" %></span></div>
                    </div>
                    
                    <div class="gst-calc">
                        <div class="calc-text">GST</div>
                        <div class="calc-fee">&#x20A6;<span id="gst-span"><%= "180.00" %></span></div>
                    </div>
                    <div class="pst-calc">
                        <div class="calc-text">PST</div>
                        <div class="calc-fee">&#x20A6;<span id="pst-span"><%= "120.00" %></span></div>
                    </div>
                    <div class="referral-calc">
                        <div class="calc-text">Delivery Fee</div>
                        <div class="calc-fee">&#x20A6;<span id="delivery-fee-span"><%= "1300.00" %></span></div>
                    </div>
                    
                    <div class="carrier-tip">
                        <div class="tip-text">Courier Tip</div>
                        <div class="tip-fee">
                            <div hidden id="session-tip">&#x20A6;<%= "200.00" %></div>
                            ...
                            <select onchange="roundTip()" id="tip-select" style="height:40px;border:none;border-radius:10px;background-color:#e00e00;color:white;text-align:right;">
                                ...
                                <option value="2.00" selected>&#x20A6;200.00</option>
                ...
                <div class="total-calculator">
                    ...
                    <div class="total-fee">&#x20A6;<span id="total-span"><%= "3000.00" %></span></div>
                ...
                <div class="first-order">
                    Get &#x20A6;600 off your next order. Invite a friend.
                </div>
        ...
        <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDkPZYodrqSw8zce9kt_gjGLrDoTcOTF0k&callback=initialize"
