...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <body onload="setApplication()">
        ...
        <div class="navigation">
            ...
            <div class="login">
               <a href="javascript:openApps()" style='text-decoration:inherit;color:inherit;'><span>Create an account, get $5</span></a> &nbsp; 
              <!-- <a href="kitchen/carrier/signup.jsp" style='text-decoration:inherit;color:inherit;'><span>Become a food courier</span></a> &nbsp; 
               ...
               --> 
                <a href="javascript:openLogin()" style='text-decoration:inherit;color:inherit;'><span>Login with an account</span></a>
            </div>
        </div>
        ...
        <div class="entrance">
            <div style="font-size:37px;height:80px;padding-top:20px;"><b><!-- broadest, an around-the-globe -->A food delivery network for offline communities.</b></div>
        ...
        <div style="width:70%;height:270px;margin-left:auto;margin-right:auto;z-index:40;top:-410px;background-color:tan;" class="modal-content" id="modal-content">
            ...
            <a href="javascript:findKitchens()">
                <div id="modal-footer" class="modal-footer">
                    <h4 style="text-align:center;height:70px;font-weight:bold;">FIND HOTSPOTS<span id="country"></span></h4>
                </div>
            </a>
        </div>
        ...
        <div class="chatline">
            ...
            <div class="chatimage">
                <a href="javascript:changeCountry()" style="color:inherit;"><img src="images/canada.svg" alt="country" /></a>
            </div>
        </div>
