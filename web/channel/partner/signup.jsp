<%-- 
    Document   : signup
    Created on : 4-Oct-2020, 1:33:49 PM
    Author     : mac
--%>
...
<html>
    <head>
        ...
        <title>Channel Partner | Pepperspot</title>
    ...
    <body onload="init()">
        ...
        <div class="navigation">
            ...
            <div class="login">
                <a href="javascript:" style='text-decoration:inherit;color:inherit;'><span>LOG IN</span></a>
            </div>
        </div>
        
        <div class="entrance">
            <h1>Order from the leading food delivery network.</h1>
            <p>All countries in the world included.</p>
        </div>
        ...
        <div class="bar">
            <div class="address-bar">
                <input type="text" id="search-address" placeholder="Enter a delivery address" />
            </div>
            <div class="bar-button">
                <button onclick="location.href='kitchens.jsp';" id="delivery-button">DELIVERY</button>
            </div>
            <div class="bar-button">
        ...
        <div class="founders">Pepperspot was founded in Winnipeg, Manitoba, Canada. With our first office opening in Kitchener, Ontario, Canada.</div>
        
        
        
        <div class="contact">
            <div class="contact-founder">Ajiri Jeffrey Osauzo, CEO (Worldwide)<br>ajirios@pepperspot.com</div>
            <div class="contact-cofounder">Brett Borkofsky, CEO (Canada)<br>bborkofsky@pepperspot.com</div>
        </div>
        
        
        
        <h5>Pepperspot Kitchens is a leading food delivery network</h5>
        <p style="font-size:14px;">Pepperspot.com Kitchens is a leading online food delivery platform pushing the frontiers of 
        ...
        <footer>
            <div class='footer-top'>
                <div class='footer-third'>
                    ...
                    <ul>
                        <li><a href="#" style='text-decoration:inherit;color:inherit;'>Telecommunications</a></li>
                        <li><a href="#" style='text-decoration:inherit;color:inherit;'>Television</a></li>
                        <li><a href="#" style='text-decoration:inherit;color:inherit;'>Movies</a></li>
                        <li><a href="#" style='text-decoration:inherit;color:inherit;'>Shows</a></li>
                        <li><a href="#" style='text-decoration:inherit;color:inherit;'>Music</a></li>
                        <li><a href="#" style='text-decoration:inherit;color:inherit;'>Game</a></li>
                        <li><a href="#" style='text-decoration:inherit;color:inherit;'>Kitchens</a></li>
                        <li><a href="#" style='text-decoration:inherit;color:inherit;'>Shopping</a></li>
                        <li><a href="#" style='text-decoration:inherit;color:inherit;'>Fashion</a></li>
                        <li><a href="#" style='text-decoration:inherit;color:inherit;'>Concerts</a></li>
                    </ul>
                </div>
                <div class='footer-third'>
                ...
                <div class='footer-third'>
                    <div class="footer-third-head">Catering Program</div>
                    <ul>
                        <li><a href="#" style='text-decoration:inherit;color:inherit;'>About</a></li>
                        <li><a href="https://www.instagram.com/officialpepperspot/" target="_blank" style='text-decoration:inherit;color:inherit;'>Press on Instagram</a></li>
                        <li><a href="https://www.linkedin.com/company/pepperspot?trk=similar-pages_result-card_full-click" target="_blank" style='text-decoration:inherit;color:inherit;'>Press on LinkedIn</a></li>
                        <li><a href="https://www.facebook.com/officialpepperspot" target="_blank" style='text-decoration:inherit;color:inherit;'>Press on Facebook</a></li>
                        ...
                        <li><a href="../../kitchen/signup.jsp" style='text-decoration:inherit;color:inherit;'>Connect your Kitchen</a></li>
            ...
            <div class='footer-bottom'>
                <div>&copy; Pepperspot Telecommunications, a subsidiary of Chill Technologies Inc. 2020. All Rights Reserved.</div>
                <div>Based in Kitchener, Ontario, Canada and Victoria Island, Lagos, Nigeria.</div>
            </div>
        </footer>
