 ...
 * @author mac
 */
@WebServlet(name = "CarrierRegister", urlPatterns = {"/carriers/register", "/carriers/signup"})
public class CarrierRegister extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet CarrierRegister</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet CarrierRegister at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
...
"        <title>Carriers | Pepperspot</title>\n" +
