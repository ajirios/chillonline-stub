 ...
 * @author mac
 */
@WebServlet(name = "tv", urlPatterns = {"/tv"})
public class tv extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet tv</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet tv at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
...
"            </div>\n" +
"            <div class=\"login\">\n" +
"               <a href=\"carriers/signup\" style='text-decoration:inherit;color:inherit;'><span>Become a distributor, earn 75%</span></a> &nbsp; \n" +
