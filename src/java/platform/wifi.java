 ...
 * @author ajirios
 */
@WebServlet(name = "wifi", urlPatterns = {"/wifi", "/telecommunications"})
...
"        <div class=\"entrance\">\n" +
"            <div style=\"font-size:37px;height:80px;padding-top:20px;\"><b>Fast, affordable, reliable WiFi access in certain locations.</b></div>\n" +
