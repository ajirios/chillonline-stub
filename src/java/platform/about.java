 ...
 * @author mac
 */
@WebServlet(name = "about", urlPatterns = {"/about", "/company"})
...
"        <title>Company | Pepperspot</title>\n" +
...
"        </div>Choose a service"
                + "<div style=\"width:480px;height:700px;margin-left:auto;margin-right:auto;text-align:center;\">"
                + "<div style=\"width:120px;height:120px;padding-top:30px;background-color:#faa61a;border-radius:15px;font-size:30px;font-weight:bold;box-shadow:0 3px 12px #ddd;color:white;text-align:center;margin:20px;float:left;\">eat.</div>"
                + "<div style=\"width:120px;height:120px;padding-top:30px;background-color:#faa61a;border-radius:15px;font-size:30px;font-weight:bold;box-shadow:0 3px 12px #ddd;color:white;text-align:center;margin:20px;float:left;\">tv.</div>"
                + "<div style=\"width:120px;height:120px;padding-top:30px;background-color:#faa61a;border-radius:15px;font-size:30px;font-weight:bold;box-shadow:0 3px 12px #ddd;color:white;text-align:center;margin:20px;float:left;\">cloud.</div>"
                + "<div style=\"width:120px;height:120px;padding-top:30px;background-color:#faa61a;border-radius:15px;font-size:30px;font-weight:bold;box-shadow:0 3px 12px #ddd;color:white;text-align:center;margin:20px;float:left;\">wifi.</div>"
                + "<div style=\"width:120px;height:120px;padding-top:30px;background-color:#faa61a;border-radius:15px;font-size:30px;font-weight:bold;box-shadow:0 3px 12px #ddd;color:white;text-align:center;margin:20px;float:left;\">dish.</div>"
                + "<div style=\"width:120px;height:120px;padding-top:30px;background-color:#faa61a;border-radius:15px;font-size:30px;font-weight:bold;box-shadow:0 3px 12px #ddd;color:white;text-align:center;margin:20px;float:left;\">music.</div>"
                + "<div style=\"width:120px;height:120px;padding-top:30px;background-color:#ccc;border-radius:15px;font-size:30px;font-weight:bold;box-shadow:0 3px 12px #ddd;color:white;text-align:center;margin:20px;float:left;\">movies.</div>"
                + "<div style=\"width:120px;height:120px;padding-top:30px;background-color:#ccc;border-radius:15px;font-size:30px;font-weight:bold;box-shadow:0 3px 12px #ddd;color:white;text-align:center;margin:20px;float:left;\">game.</div>"
                + "<div style=\"width:120px;height:120px;padding-top:30px;background-color:#ccc;border-radius:15px;font-size:30px;font-weight:bold;box-shadow:0 3px 12px #ddd;color:white;text-align:center;margin:20px;float:left;\">fiber.</div>"
                + "</div>"
                + ""
                + "<div style=\"width:70%;height:700px;margin-left:auto;margin-right:auto;text-align:center;float:left;\">"
                + "&copy; Pepperspot Telecommunications. 2021. All Rights Reserved."
                + "</div>\n");
        
        
        
        page.println("<div hidden class=\"service-map\">\n" +
"            <div class=\"faq-heading\">Meet our Community</div>\n" +
