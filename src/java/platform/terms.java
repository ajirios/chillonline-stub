...
public class terms extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet terms</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet terms at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
...
"            <div class=\"service-faq\">\nWe have a very robust food delivery architecture that adapts seamlessly to both easy and tough terrains such as the third-world landscape." +
