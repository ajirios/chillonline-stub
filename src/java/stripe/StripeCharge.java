...

{
    ...
    {
        String publishableTestApiKey = "pk_test_duHKrEBWghDvhdwItiKJQbMB003cJ3wceh";
        String testApiKey = "";
        String publishableLiveApiKey = "pk_live_q8i4ti8zLcLclwASWYMoVFje00uMysfz3N";
        String liveApiKey = "";
        ...
        cardMap.put("receipt_email", "ajirios@snapcart.ca");
        cardMap.put("source", publishableTestApiKey);
